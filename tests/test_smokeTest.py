...
class TestSmokeTest():
    ...
    def test_homepage(self):
        ...
        self.driver.set_window_size(1709, 1299)
        ...
        assert len(elements) > 0
        elements = self.driver.find_elements(
            By.CSS_SELECTOR, ".spotlight1 img")
        assert len(elements) > 0
        elements = self.driver.find_elements(
            By.CSS_SELECTOR, ".spotlight2 img")
        assert len(elements) > 0
    ...
    def test_directorypage(self):
        ...
        self.driver.find_element(
            By.CSS_SELECTOR, ".gold-member:nth-child(9) > p:nth-child(2)").click()
        assert self.driver.find_element(
    ...
    def test_joinpage(self):
        ...
        self.driver.find_element(By.NAME, "lname").send_keys("Turay")
        self.driver.find_element(By.NAME, "bizname").send_keys("Koi\'s")
    ...
    def test_adminpage(self):
        ...
        assert self.driver.find_element(
            By.CSS_SELECTOR, ".errorMessage").text == "Invalid username and password."
